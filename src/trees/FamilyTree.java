...
public class FamilyTree
{
    ...
    private static class TreeNode<T>
    {
        ...
        TreeNode<T> getNodeWithInfo(String targetData)
        {
            ...
            for (TreeNode<T> child: children)
            {
            	...
            	TreeNode<T> target = child.getNodeWithInfo(targetData);
            	if (target != null)
            		return target;
            }
	...
	private void addLine(String line) throws TreeException
	{
		...
		{
			parentNode = root.getNodeWithInfo(parent);
			if (parentNode == null) {
				throw new TreeException("Invalid file data");
			}
		}
		...
		for (String s: childrenArray) {
			parentNode.addChild(new TreeNode<String>(s));
		}
	}
	...
	TreeNode<String> getMostRecentCommonAncestor(String name1, String name2) throws TreeException
	{
		...
		TreeNode<String> node1 = root.getNodeWithInfo(name1);		// node whose name is name1
		if (node1 == null)
			throw new TreeException("name1 not found");
		TreeNode<String> node2 = root.getNodeWithInfo(name2);
		if (node2 == null)
			throw new TreeException("name1 not found");
